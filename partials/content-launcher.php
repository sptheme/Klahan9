...
<?php $post_format = get_post_format();
	...
	if ( $post_format == 'video' ) : 
		...
		the_title( sprintf( '<h3 class="entry-title" itemprop="name"><a class="watch-now" itemprop="url" href="%1$s" rel="bookmark" title="%2$s">', esc_url( $video_url ), esc_attr( get_the_title() ) ), '</a></h3>' );
	else :
		...
		the_title( sprintf( '<h3 class="entry-title" itemprop="name"><a class="listen-now" itemprop="url" href="https://w.soundcloud.com/player/?visual=true&amp;url=%1$s&amp;show_artwork=true&amp;maxwidth=1020&amp;maxheight=1000&amp;auto_play=1" rel="bookmark" title="%2$s"" rel="bookmark" title="%2$s">', esc_url( $sound_url ), esc_attr( get_the_title() ) ), '</a></h3>' );
	endif; ?>
